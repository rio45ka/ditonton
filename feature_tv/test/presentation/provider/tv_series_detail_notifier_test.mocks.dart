...
// in feature_tv/test/presentation/provider/tv_series_detail_notifier_test.dart.
...
import 'package:feature_tv/domain/entities/tv_series.dart' as _i9;
...
class MockGetTvSeriesDetailUseCase extends _i1.Mock
    implements _i4.GetTvSeriesDetailUseCase {
...
/// A class which mocks [GetRecommendationsTvSeriesUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetRecommendationsTvSeriesUseCase extends _i1.Mock
    implements _i8.GetRecommendationsTvSeriesUseCase {
  MockGetRecommendationsTvSeriesUseCase() {
    _i1.throwOnMissingStub(this);
  }
...
/// A class which mocks [GetTvSeriesWatchListStatusUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetTvSeriesWatchListStatusUseCase extends _i1.Mock
    implements _i10.GetTvSeriesWatchListStatusUseCase {
...
/// A class which mocks [SaveTvSeriesWatchlistUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockSaveTvSeriesWatchlistUseCase extends _i1.Mock
    implements _i11.SaveTvSeriesWatchlistUseCase {
  MockSaveTvSeriesWatchlistUseCase() {
    _i1.throwOnMissingStub(this);
  }
...
/// A class which mocks [RemoveTvSeriesWatchlistUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockRemoveTvSeriesWatchlistUseCase extends _i1.Mock
    implements _i12.RemoveTvSeriesWatchlistUseCase {
  MockRemoveTvSeriesWatchlistUseCase() {
    _i1.throwOnMissingStub(this);
  }
